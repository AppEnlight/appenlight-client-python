...
class TestTimingHTTPLibs(object):
    def setUpClient(self, config={}):
        self.client = client.Client(config)
...
class TestDBApi2Drivers(object):
    def setUpClient(self, config={}):
        self.client = client.Client(config)
...
class TestDjangoTemplates(object):
    def setUpClient(self, config={}):
        self.client = client.Client(config)
